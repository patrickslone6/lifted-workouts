...
// Older versions of Lifted stored incomplete profile objects. Normalize them
// before App initializes so the workout engine never crashes on missing arrays.
try {
  ...
  console.warn('Lifted profile normalization skipped:', error);
}
